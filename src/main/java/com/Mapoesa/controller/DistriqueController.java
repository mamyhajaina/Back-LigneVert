...
import com.Mapoesa.service.DistriqueService;


@RestController
@RequestMapping("distrique")
public class DistriqueController {
	...
	@GetMapping("/inserte")
	public ResponseEntity<ReponseHttp> inserte(@RequestBody Distrique inpute) throws SQLException 
	{
		try (Connection con=jdbc.getDataSource().getConnection()) {	
