...
import com.Mapoesa.service.PrioriteService;
...
public class PrioriteController {
	...
	@GetMapping("/inserte")
	public ResponseEntity<ReponseHttp> inserte(@RequestBody Priorite inpute) throws SQLException 
	{
		try (Connection con=jdbc.getDataSource().getConnection()) {	
